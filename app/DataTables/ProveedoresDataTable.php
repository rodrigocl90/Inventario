...
class ProveedoresDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        ->editColumn('created_at', function ($query) {
            ...
            ->addColumn('action', 'rolesdatatable.action')->addColumn('action',function ($Personas) {
                $nm=$Personas->id;
    ...
    public function query(Personas $model)
    {
        ...
        return $model->newQuery()->select('id','nombre','documento','numero','telefono','email','created_at','updated_at','direccion','giro')->where('tipo','=',2);;
    }
