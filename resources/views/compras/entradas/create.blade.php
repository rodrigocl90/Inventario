...
<nav aria-label="breadcrumb ">
  ...
  <ol class="breadcrumb arr-right bg-dark ">
    ...
    <li class="breadcrumb-item text-light active" aria-current="page">Lista de Entradas</li>

  
    <li class="breadcrumb-item text-light active" aria-current="page">Entradas</li>
  </ol></nav>
...
<div class="col-md-4">
  ...
  <input type="text" class="tipo_operacion" maxlength="10" id="tipo_operacion" name="tipo_operacion" value="2" hidden>
    </div>
...
document.getElementById("total").value=conComas(suma);
  ...
  $('#temporal').load("{{ route('entradas.temporal') }}");
