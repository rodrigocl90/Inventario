...
<nav aria-label="breadcrumb ">
  ...
  <ol class="breadcrumb arr-right bg-dark ">
    ...
    <li class="breadcrumb-item text-light active" aria-current="page">Lista de Proveedores</li>
  ...
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Tú quieres borrar el proveedor   <label for="recipient-name" class="alert-danger" id="Dnombre" name="Dnombre"></label> ? Esto no puede ser regresado.</p>
      </div>
  ...
  <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header alert-success" >
                <h3 class="modal-title">Proveedores</h1>
            </div>
            <div class="modal-body">
...
<input  class="form-control form-control{{ $errors->has('numero') ? ' is-invalid' : '' }}" type="text" id="numero" name="numero" placeholder="ingrese Número de Documento" maxlength="20" value="{{old('numero') }}" required>
         ...
         <div class="form-group">
    <label class="control-label">Giro Empresa</label>
                 <div class="input-group">
...
<input  class="form-control form-control{{ $errors->has('giro') ? ' is-invalid' : '' }}" type="text" id="giro" name="giro" placeholder="ingrese giro empresa" maxlength="500" value="{{old('giro') }}" required>
    </div>
</div>
...
<div class="input-group mb-3">
 ...
 <label class="control-label">Email del proveedor :</label>
<div class="input-group mb-3">
  <div class="input-group-prepend">
...
<input  class="form-control form-control{{ $errors->has('Egiro') ? ' is-invalid' : '' }}" type="text" id="Egiro" name="Egiro" placeholder="ingrese giro Empresa" maxlength="500" value="{{old('Egiro') }}" required>
    </div>
</div>
...
<div class="input-group mb-3">
 ...
 <div align="center">
      <button type="button" name="create_record" id="create_record" class="btn btn-warning btn-sm fa fa-smile-o">Crear Nuevo Proveedor</button>
</div>
...
//PARA EDITAR
 ...
 $(document).on('click', '.delete', function(){
  ...
  $.ajax({
   url:"proveedores/pcrud/edit/"+user_id,
   dataType:"json",
   success:function(html){
 ...
 url:"proveedores/pcrud/destroy/"+user_id,
